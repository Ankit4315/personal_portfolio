...
const Dashboard = () => {
  ...
  const gotoManageSkills = () => {
    navigateTo("/dashboard/manage/skills");
  };
  const gotoManageTimeline = () => {
    navigateTo("/dashboard/manage/timeline");
  };
  const gotoManageProjects = () => {
    navigateTo("/dashboard/manage/projects");
  };
  ...
  console.log("Software Applications data:", softwareApplications);
        ...
        <main className="grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8 lg:grid-cols-2 xl:grid-cols-2">
          <div className="grid auto-rows-max items-start gap-4 md:gap-8 lg:col-span-2">
                            ...
                            return (
                              <TableRow className="bg-accent" key={element._id}>
                                ...
                                <TableCell className="md:table-cell">
                                  <Link to={`/dashboard/update/project/${element._id}`}>
            ...
            <Tabs defaultValue="applications">
              <TabsList className="mb-4">
                <TabsTrigger value="applications">Applications & Timeline</TabsTrigger>
              </TabsList>
              <TabsContent value="applications" className="grid min-[1050px]:grid-cols-2 gap-4">
                <Card>
                  <CardHeader className="px-7">
